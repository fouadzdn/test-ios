...
//        self.LogInTocontinue.font = SwiftFunctions.GetCustomBodyFont(EngFontNumber: 13, ArFontNumber: 16)
        ...
        self.emailTextField.text = DatabaseCalls.GetDataFromLocal(WordId: "UserName") as? String ?? ""
        
        self.passwordTextField.text = DatabaseCalls.GetDataFromLocal(WordId: "UserPass") as? String ?? ""
        if((DatabaseCalls.GetDataFromLocal(WordId: "UserPass") as? String ?? "") != "")
        {
...
//            UserDefaults.standard.set("", forKey: "UserPass")
            DatabaseCalls.SaveDataToLocal(WordId: "UserPass", DataArray: "")
...
//        let Url = String(format: "https://m.peoplemon.com/MaWcf.svc/Authenticate")
        ...
        request.setValue("MOBILE", forHTTPHeaderField: "DEVICE_TYPE")
        request.setValue("\(IP)", forHTTPHeaderField: "IP")
        request.setValue(DatabaseCalls.GetDataFromLocal(WordId: "APIKey") as? String ?? "", forHTTPHeaderField: "APIKey")
...
//                                                            UserDefaults.standard.set(self.passwordTextField.text, forKey: "UserPass")
                                                            DatabaseCalls.SaveDataToLocal(WordId: "UserPass", DataArray: self.passwordTextField.text)
                                                        }
                                                        
//                                                        UserDefaults.standard.set(self.emailTextField.text, forKey: "UserName") //UserName
                                                        DatabaseCalls.SaveDataToLocal(WordId: "UserName", DataArray: self.emailTextField.text)
                                                        //                                                                                        UserDefaults.standard.set(true, forKey: "UpdateWall")
//                                                        UserDefaults.standard.set((jsonDataDictionary.object(forKey: "APIKey") as? String ?? ""), forKey: "APIKey")
                                                        DatabaseCalls.SaveDataToLocal(WordId: "APIKey", DataArray: (jsonDataDictionary.object(forKey: "APIKey") as? String ?? ""))
                                                        
//                                                        UserDefaults.standard.set((jsonDataDictionary.object(forKey: "IS_SYSTEM_ADMIN") as? String ?? ""), forKey: "IS_SYSTEM_ADMIN")
                                                        DatabaseCalls.SaveDataToLocal(WordId: "IS_SYSTEM_ADMIN", DataArray: (jsonDataDictionary.object(forKey: "IS_SYSTEM_ADMIN") as? String ?? ""))
                                                        
//                                                        UserDefaults.standard.set("\(jsonDataDictionary.object(forKey: "FIRST_NAME") as? String ?? "") \(jsonDataDictionary.object(forKey: "LAST_NAME") as? String ?? "")", forKey: "FULL_NAME")
                                                        DatabaseCalls.SaveDataToLocal(WordId: "FULL_NAME", DataArray: "\(jsonDataDictionary.object(forKey: "FIRST_NAME") as? String ?? "") \(jsonDataDictionary.object(forKey: "LAST_NAME") as? String ?? "")")
                                                        
//                                                        UserDefaults.standard.synchronize()
                                                     
                                                        let mainStoryboard: UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
                                                        var tableViewController = mainStoryboard.instantiateViewController(withIdentifier: "Navi") as! UINavigationController
