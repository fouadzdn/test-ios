...
extension PDFViewController {
    ...
    public class func createNew(with document: PDFDocument, title: String? = nil, actionButtonImage: UIImage? = nil, actionStyle: ActionStyle = .print, backButton: UIBarButtonItem? = nil, isThumbnailsEnabled: Bool = true, startPageIndex: Int = 0,PhoneFouad : String = "",documentURLFouad : String = "") -> PDFViewController {
        
        let storyboard = UIStoryboard(name: "PDFReader", bundle: Bundle(for: PDFViewController.self))
        let controller = storyboard.instantiateInitialViewController() as! PDFViewController
        controller.document = document
        controller.documentURLFouad = documentURLFouad
        controller.PhoneFouad = PhoneFouad
...
public final class PDFViewController: UIViewController {
    ...
    private var documentURLFouad: String = ""
    private var PhoneFouad: String = ""
...
//           }
        ...
        let urlWhats = "whatsapp://send?phone=\(self.PhoneFouad)&text=\(self.documentURLFouad)"
...
////        var activityVc: UIDocumentInteractionController!
//          var activityVc = UIDocumentInteractionController(url: URL(fileURLWithPath: "https://www.mypdv.com/Rest/myPDVserv/pdf/DJ0196171815896116273038500.pdf"))
