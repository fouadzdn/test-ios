...
//        cell.optionLabel.textAlignment = .center
	...
	public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if(self.TypeES == "Option")
        {
        var Object = NSMutableDictionary()
        Object.setValue(selectedRowIndex, forKey: "Index")
        NotificationCenter.default.post(name: Notification.Name("TicketListFilter"), object: Object)
        }
        
        if(self.TypeES == "Sales")
        {
        var Object = NSMutableDictionary()
        Object.setValue(selectedRowIndex, forKey: "Index")
        NotificationCenter.default.post(name: Notification.Name("SalesManListFilter"), object: Object)
        }
